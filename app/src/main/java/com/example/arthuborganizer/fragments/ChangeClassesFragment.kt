...
import com.example.arthuborganizer.databinding.FragmentChangeClassesBinding
...
class ChangeClassesFragment : Fragment(), RecyclerViewAdapter.OnClickListener {
    private lateinit var binding : FragmentChangeClassesBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentChangeClassesBinding.inflate(inflater, container, false)

        binding.navBar.tvNavBarLabel.text = getString(R.string.navBarChangeClasses)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.rvChangeClassesFragment.setHasFixedSize(true)
        binding.rvChangeClassesFragment.layoutManager = LinearLayoutManager(context)

        mList = mutableListOf()
        adapter = RecyclerViewAdapter(mList)
        adapter.setListener(this)
        binding.rvChangeClassesFragment.adapter = adapter
    ...
    override fun onItemClick(item: RecyclerViewItem) {
        ...
        navControl.navigate(R.id.action_changeClassesFragment_to_editClassFragment)
    }

    private fun back() {
        if (sharedViewModel.role == "officeWorker") {
            navControl.navigate(R.id.action_changeClassesFragment_to_officeWorkerMenuFragment)
        } else {
            navControl.navigate(R.id.action_changeClassesFragment_to_adminMenuFragment)
        }
    }
}